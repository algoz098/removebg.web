...
export class ModelPreloader {
  ...
  async startPreloading() {
    ...
    console.log('🤖 Verificando recursos locais...');
  ...
  async preloadModel() {
    try {
      ...
      if (cacheStats.count > 0) {
        console.log(`💾 Encontrados ${cacheStats.count} recursos em cache (${cacheStats.formattedSize})`);
      ...
      // Log para mostrar início do download
      ...
      console.log('✅ Toast de carregamento removido');
      ...
      const message = finalStats.count > cacheStats.count 
        ? `🎉 Modelo carregado! +${finalStats.count - cacheStats.count} novos recursos (${finalStats.formattedSize} total)` 
        : `✅ Modelo carregado usando cache! (${finalStats.formattedSize})`;
      ...
      console.log('❌ Erro no carregamento do modelo');
